...
export function render() {
  ...
  const socialIconMap = {
    ...
    twitter: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 shrink-0"><path d="M4 4l11.733 16h4.267l-11.733 -16z"></path><path d="M20 4L4 20"></path></svg>`,
