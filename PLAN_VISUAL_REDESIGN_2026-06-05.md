...
| F9 | Marketplace — hero + tabs + filtros | `[~] EN_REVISION` | Hero `rd-hero-gradient`, tabs píldora con iconos Lucide, wrapper `rd-canvas rd-section`, intro grad-violet y filtros beige/píldora. Cards de item quedan para F10. |
